...
function Translator(props: unknown): unknown {
	...
	if (typeof props === 'string') {
		...
		if (ipcRenderer) {
			if (translatedString == "") ipcRenderer.invoke('translator.GetTranslation', props).then(_ => setTranslatedString(_));
		}
		...
		if (ipcRenderer) {
			if (translatedString == "") ipcRenderer.invoke('translator.GetTranslation', props['translation']).then(_ => setTranslatedString(_));
		}
